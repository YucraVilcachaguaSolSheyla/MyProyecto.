 ...
 * @author USER
 */
public class ControladorReportePorAñoFiscal {
 ...
 */
     ...
     public ControladorReportePorAñoFiscal(ArrayList<RegistroMaestro> registros) {
    }

    public void generarReportePorAñoFiscal(String rutaCSV, String rutaSalidaTXT) {
        Map<Integer, Integer> conteoAño = new TreeMap<>();
            ...
            if (linea == null) errores.add("Archivo vacio");
                ...
                while ((linea = br.readLine()) != null) {
                    ...
                    try {
                        ...
                        if (c.length < 15) { errores.add("Linea " + ln + ": columnas insuficientes. Se encontraron " + c.length + ". Se requieren 15."); continue; } 
                        ...
                        int añoFiscal = rm.getEntidades().getAñoFiscal();
                        conteoAño.put(añoFiscal, conteoAño.getOrDefault(añoFiscal, 0) + 1);
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(rutaSalidaTXT))) {
            pw.println("REPORTE POR AÑO FISCAL");
            pw.println("=======================");
            for (Map.Entry<Integer, Integer> e : conteoAño.entrySet()) {
        ...
        if (!errores.isEmpty()) {
            try (PrintWriter pe = new PrintWriter(new FileWriter(rutaSalidaTXT + ".errores.txt"))) {
                pe.println("ERRORES - Reporte Por Año Fiscal");
