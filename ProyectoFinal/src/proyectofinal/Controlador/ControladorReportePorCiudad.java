 ...
 * @author USER
 */
public class ControladorReportePorCiudad {
    

    
    public ControladorReportePorCiudad(ArrayList<RegistroMaestro> registros) {
    }

    public void generarReportePorCiudad(String rutaCSV, String rutaSalidaTXT) {
        Map<String, Integer> conteoCiudad = new TreeMap<>();
            ...
            if (linea == null) errores.add("Archivo vacio");
                ...
                while ((linea = br.readLine()) != null) {
                    ...
                    try {
                        ...
                        String ciudad = rm.getLogistica().getCiudadEntrega();
                        conteoCiudad.put(ciudad, conteoCiudad.getOrDefault(ciudad, 0) + 1);
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(rutaSalidaTXT))) {
            pw.println("REPORTE POR CIUDAD");
            pw.println("===================\n");
            for (Map.Entry<String, Integer> e : conteoCiudad.entrySet()) {
        ...
        if (!errores.isEmpty()) {
            try (PrintWriter pe = new PrintWriter(new FileWriter(rutaSalidaTXT + ".errores.txt"))) {
                pe.println("ERRORES - Reporte Por Ciudad");
